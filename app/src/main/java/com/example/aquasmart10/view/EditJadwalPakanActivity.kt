...
import com.example.aquasmart10.component.EditJadwalPanen
...
import com.example.aquasmart10.crud.pakan.EditJadwalPakanBody

@Composable
fun EditJadwalPakanActivity(navController: NavController) {
    Scaffold(
        bottomBar = {
