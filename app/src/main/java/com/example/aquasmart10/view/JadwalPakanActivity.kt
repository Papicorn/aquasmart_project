...
import com.example.aquasmart10.crud.ikan.StokIkan
import com.example.aquasmart10.crud.pakan.JadwalPakanBody
import com.example.aquasmart10.crud.pakan.StokPakanBody
...
fun JadwalPakanScreen(navController: NavController) {
    Scaffold(
        ...
        floatingActionButton = {
            FloatingActionButton(
                onClick = { navController.navigate(Routes.TambahPakanScreen)},
                modifier = Modifier
                    .size(60.dp)
